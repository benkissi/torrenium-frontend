  ...
  switch (action.type) {
    ...
    case FORM_TYPES.SET_INPUT_ERROR:
      return {
        ...
        [action.payload.key + "Message"]: action.payload[
          action.payload.key + "Message"
        ],
...
export const appReducer = (state, action) => {
  switch (action.type) {
    ...
    case APP_TYPES.SET_MATCHING_JOBS:
      return {
        ...
        matchingJobs: {
          ...
          jobs: action.payload.jobs.results,
        },
      };
    ...
    case APP_TYPES.ADD_JOBS:
      const updatedJobs = [...state.matchingJobs.jobs, ...action.payload];
      return {
        ...state,
        matchingJobs: {
            ...state.matchingJobs,
